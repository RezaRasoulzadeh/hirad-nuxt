          ...
          <ul class="menu menu-horizontal px-1 lg:ps-8 pt-1 pb-0 gap-0 font-medium h-full items-center whitespace-nowrap">
            ...
            <li class="h-full flex items-center">
              <button @click="$emit('open-drawer')"
                class="h-full flex items-center justify-center px-4 rounded-none text-base-content hover:bg-primary/5 hover:text-primary hover:border-primary border-b-3 border-transparent transition-all duration-300 ease-in-out gap-2 group layout-nav-btn">
            ...
            <li class="h-full flex items-center">
              <div class="relative h-full flex items-center group p-0 rounded-none">
                <div tabindex="0" role="button"
                  class="h-full px-4 rounded-none text-base-content border-b-3 border-transparent transition-all duration-300 ease-in-out flex items-center justify-center gap-2 group-hover:text-primary group-hover:border-primary">
