...
export const resourcesCopy = {
  ...
  materialDatabase: {
    ...
    description: {
      fa: 'جست‌وجو و مقایسه داده‌های مواد اتصالات جوشی لوله از جدول کاتالوگ هیراد، بر پایه شناسه‌های مشخصات و گریدهای ASTM ذکرشده در منبع.',
      en: 'Search and compare Hirad Catalogue reference data for pipe welding fitting materials, based on the ASTM specification and grade identifiers cited in the source table.',
    },
    ...
    sourceIdentifier: { fa: 'شناسه در جدول هیراد', en: 'Identifier in Hirad table' },
...
export const resourceTools: ResourceCardDefinition[] = [
  ...
  },
  {
    ...
    description: {
      fa: 'جست‌وجو، بررسی و مقایسه داده‌های مواد اتصالات جوشی در جدول کاتالوگ هیراد.',
      en: 'Search and compare pipe welding fitting material data from the Hirad Catalogue reference table.',
    },
    icon: FlaskConical,
